...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LEFT_CTRL,   KC_Z,       KC_X,       KC_C,       KC_V,                   KC_B,               KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_NUHS,
                                                ...
                                                MO(LY_NAV), LT(LY_DEV,KC_SPACE),    KC_BACKSPACE,       KC_DEL,     KC_ENTER,   MO(LY_NUM)
    ),
    [LY_NAV] = LAYOUT(
    ...
    [LY_DEV] = LAYOUT(
        ...
        _______,    RALT(KC_7),     KC_ASTR,    KC_LPRN,        RALT(KC_0), M_BCKTCK,           RALT(DE_PLUS),  _______,    _______,    _______,    _______,    _______,
        _______,    RALT(KC_8),     KC_NUBS,    LSFT(KC_NUBS),  RALT(KC_9), DE_CIRC,            LSFT(DE_PLUS),  _______,    _______,    _______,    _______,    _______,
        _______,    RALT(KC_NUBS),  KC_AMPR,    RALT(KC_MINS),  KC_BSLS,    M_LAMBDA,           DE_PLUS,        _______,    _______,    _______,    _______,    _______,
                                                _______,        _______,    _______,            _______,        _______,    _______,
                                                _______,        _______,    _______,            _______,        _______,    _______
    ),
    [LY_NUM] = LAYOUT(
